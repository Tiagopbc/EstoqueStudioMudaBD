...
-- Adicionando as colunas separadas de endereço para funcionário
...
-- Remover a coluna de endereço antiga
ALTER TABLE funcionario;
...
-- Adicionando as colunas separadas de endereço para cliente
ALTER TABLE cliente
ADD COLUMN cep VARCHAR(10),
ADD COLUMN rua VARCHAR(100),
ADD COLUMN numero VARCHAR(10),
